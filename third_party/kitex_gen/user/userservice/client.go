...
type Client interface {
	...
	VerifyAndRegister(ctx context.Context, Req *user.VerifyAndRegisterRequest, callOptions ...callopt.Option) (r *user.RegisterResponse, err error)
...
func (p *kUserServiceClient) VerifyAndRegister(ctx context.Context, Req *user.VerifyAndRegisterRequest, callOptions ...callopt.Option) (r *user.RegisterResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.VerifyAndRegister(ctx, Req)
}
