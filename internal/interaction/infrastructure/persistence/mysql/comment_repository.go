...
func NewCommentRepository() repo.CommentRepository {
...
func (r *CommentRepository) Delete(ctx context.Context, id int64) error {
    if err := mysql.GetDB().WithContext(ctx).Delete(&CommentPO{}, id).Error; err != nil {
...
func (r *CommentRepository) ListByVideo(ctx context.Context, videoID int64, page, size int) ([]*entity.Comment, int64, error) {
    ...
    db := mysql.GetDB().WithContext(ctx).Model(&CommentPO{}).
...
func (r *CommentRepository) IncrementLike(ctx context.Context, id int64) error {
    if err := mysql.GetDB().WithContext(ctx).Model(&CommentPO{}).Where("id = ?", id).
